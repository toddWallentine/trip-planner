                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="airline"><g:message code="trip.airline.label" default="Airline" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: tripInstance, field: 'airline', 'errors')}">
                                    <g:select name="airline.id" from="${trip.planner.Airline.list()}" optionKey="id" value="${tripInstance?.airline?.id}"  />
                                </td>
                            </tr>
